...
!--------------------------------------------------------------------------
  ...
  CHARACTER(LEN=*), PARAMETER, PUBLIC :: GID_NULL = CHAR(0)//CHAR(0)//CHAR(0)//CHAR(0)
...
!--------------------------------------------------------------------------
  ...
  PUBLIC :: GiD_BeginPDMMatResult, GiD_BeginMainMatResult, GiD_BeginLAResult, GiD_BeginResultHeader, GiD_BeginComplexScalarResult, GiD_BeginComplexVectorResult
  PUBLIC :: GiD_fBeginPDMMatResult, GiD_fBeginMainMatResult, GiD_fBeginLAResult, GiD_fBeginResultHeader, GiD_fBeginComplexScalarResult, GiD_fBeginComplexVectorResult
  ...
  PUBLIC :: GiD_fWriteScalar, GiD_fWriteVector, GiD_fWrite2DVector, GiD_fWrite3DVector, GiD_fWriteVectorModule, GiD_fWrite2DMatrix
  PUBLIC :: GiD_Write3DMatrix, GiD_WritePlainDefMatrix, GiD_WriteMainMatrix, GiD_WriteLocalAxes, GiD_WriteComplexScalar, GiD_WriteComplexVector
  PUBLIC :: GiD_fWrite3DMatrix, GiD_fWritePlainDefMatrix, GiD_fWriteMainMatrix, GiD_fWriteLocalAxes, GiD_fWriteComplexScalar, GiD_fWriteComplexVector
  PUBLIC :: OPERATOR(==)
...
!--------------------------------------------------------------------------
  ...
  FUNCTION C_PTR_STRING(string_for,string_cpp)
    ...
    IF( string_for .NE. GID_NULL ) THEN
