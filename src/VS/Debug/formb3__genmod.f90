        !COMPILER-GENERATED INTERFACE MODULE: Tue Jun 27 10:35:33 2023
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE FORMB3__genmod
          INTERFACE 
            SUBROUTINE FORMB3(INT,IEL,ICON,CO,B,DET,DSHAPEVALUESARRAY,  &
     &MAXPARTICLE,MAXEL,GETPARTICLEINDEX)
              ...
              REAL(KIND=8), INTENT(IN) :: CO(COUNTERS%NODTOT,NDIM)
              REAL(KIND=8), INTENT(OUT) :: B(NDIM,ELEMENTNODES)
