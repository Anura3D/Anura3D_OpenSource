...
!        Subroutine ESM_AM(NPT,NOEL,IDSET,STRESS,EUNLOADING,PLASTICMULTIPLIER, &
...
!      real(REAL_TYPE), dimension(NTENS), intent(inout) :: STRESS!(NTENS)
!      real(REAL_TYPE), dimension(NSTATEV), intent(inout) :: STATEV!(NSTATEV)
!      real(REAL_TYPE), dimension(NTENS,NTENS), intent(out) :: DDSDDE!(NTENS,NTENS),
!      real(REAL_TYPE), dimension(NTENS), intent(out) :: DDSDDT!(NTENS),
!      real(REAL_TYPE), dimension(NTENS), intent(out)  :: DRPLDE!(NTENS),
!      real(REAL_TYPE), dimension(NTENS), intent(in) :: STRAN!(NTENS),
!      real(REAL_TYPE), dimension(NTENS), intent(in) :: DSTRAN!(NTENS),
!      real(REAL_TYPE), dimension(2), intent(in)  :: TIME!(2),
!      real(REAL_TYPE), dimension(1), intent(in)  :: PREDEF!(1)
!      real(REAL_TYPE), dimension(1), intent(in)  :: DPRED!(1),
!      real(REAL_TYPE), dimension(NPROPS), intent(in)  :: PROPS!(NPROPS),
!      real(REAL_TYPE), dimension(3), intent(in) :: COORDS!(3),
!      real(REAL_TYPE), dimension(3,3), intent(in) :: DROT!(3,3),
!      real(REAL_TYPE), dimension(3,3), intent(in) :: DFGRD0!(3,3),
!      real(REAL_TYPE), dimension(3,3), intent(in) :: DFGRD1!(3,3)
!
!      integer(INTEGER_TYPE), intent(in) :: NPT
!      
!      
!        ! Arguments:
!        !          I/O  Type
...
! 
!        !---  Local variables
!      real(REAL_TYPE), dimension(NTENS) :: dSig
!      real(REAL_TYPE), dimension(NTENS) :: Sig
!      real(REAL_TYPE), dimension(NTENS) :: SigC
!      real(REAL_TYPE), dimension(NTENS) :: SigE
!      real(REAL_TYPE), dimension(NTENS) :: SigEQ
!      real(REAL_TYPE), dimension(3) :: xN1
!      real(REAL_TYPE), dimension(2) :: xN2
!      real(REAL_TYPE), dimension(3) :: xN3
!      real(REAL_TYPE), dimension(3) :: Tmp1
!      real(REAL_TYPE), dimension(3) :: Tmp2
!      real(REAL_TYPE), dimension(3) :: Tmp3
!      !real(REAL_TYPE), dimension(NTENS) :: 
!      !real(REAL_TYPE), dimension(NTENS) :: 
!      
...
!      integer(INTEGER_TYPE) :: IAPEX
!      integer(INTEGER_TYPE) :: ITENS
!      integer(INTEGER_TYPE) :: TauMax
!      integer(INTEGER_TYPE) :: IntGlo
!      real(REAL_TYPE) :: G, ENU, VNU
!      integer(INTEGER_TYPE) :: one
!      integer(INTEGER_TYPE) :: two
!      real(REAL_TYPE) ::SPHI
!      real(REAL_TYPE) ::SPSI
!      real(REAL_TYPE) ::COHS, TENS
!      real(REAL_TYPE) ::FAC, D1, D2, DSTRANVOL
!      real(REAL_TYPE) ::Q
