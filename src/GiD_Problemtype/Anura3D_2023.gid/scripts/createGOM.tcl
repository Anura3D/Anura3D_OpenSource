...
proc Anura3D::WriteCalculationFile_GOM { filename } {
    ...
    # Set the element flag  based on the element type
    if { ($elem_type == "Triangle") && ($elem_num_nodes == "3") } {
        GiD_WriteCalculationFile puts "triangular_3-noded"
    } elseif { ($elem_type == "Quadrilateral") && ($elem_num_nodes == "4") } {
        GiD_WriteCalculationFile puts "quadrilateral_4-noded"
    } elseif { ($elem_type == "Quadrilateral") && ($elem_num_nodes == "8") } {
    ...
    ### Formatted until here wavehello
    set num [llength $formats_mp]
    if { $num != 0 } {
        set num [llength $formats_mp]
